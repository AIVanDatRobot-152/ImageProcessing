...
img_path1 = r'F:\StudyatCLass\Study\class\Xulianhso\Code\jetplane.tif'
img_path2 = r'F:\StudyatCLass\Study\class\Xulianhso\Code\lena.tif'

# Đọc ảnh và chuyển sang xám
img = cv2.imread(img_path1, cv2.IMREAD_GRAYSCALE)
img2 = cv2.imread(img_path2, cv2.IMREAD_GRAYSCALE)

gray_level = np.array(list(range(256)))
